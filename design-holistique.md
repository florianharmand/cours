...
Le design numérique, champ spécifique du design frayant avec les techniques numériques, est coutumier des situations et projets complexes. Le design numérique se positionne à l'intersection des disciplines, ce qui permet de les articuler dans une démarche créative : il est à la fois nodal et nexial. Mais la méta-discipline du design n'est pas en reste, elle requiert tout autant des concepts opératoires soutenant les pratiques des designers.

Pour autant ces concepts ne sont pas des théories hors-sols. Ils proviennent eux-mêmes, pour la plupart, de réflexions et prises de recul depuis le terrain : ils sont les fruits d'une **approche réflexive** du design.

Bien que de nombreux concepts jalonnent voire structurent la théorie du design en perpétuelle évolution, nous nous intéresserons dans ce cours à trois concepts permettant d'appréhender un terrain ou objet complexe. Ce sont les concepts de **système**, de **réseau** et de **dispositif**.
...
Le biologiste autrichien Ludwig von Bertalanffy a passé une partie de sa vie à étudier et théoriser les systèmes. Il est l'auteur de la *Théorie Générale des Systèmes*, publiée en 1968, mais il avait déjà émis l'idée d'une "science des systèmes" trente ans plus tôt.

Dans le texte, Von Bertalanffy prône une approche globale d'un phénomène, non une étude focalisée sur un unique objet :
...
Le scientifique cherche à sortir des modèles fermés de la physique pour trouver des caractéristiques systémiques touchant tant les objets que les êtres vivants :
...
La théorie mathématique de l’information à transposer le concept d'**entropie** de la thermodynamique au champ de l'information. Pour Claude Shannon, l'entropie est "la mesure de l'incertitude" (Shannon, 1948) d'un système.

Norbert Wiener a prolongé cette définition qui sert de point de départ à la cybernétique :

> La notion de quantité d’information se rattache très naturellement à une notion classique en mécanique statistique : celle d’entropie. Tout comme la quantité d’information dans un système est la mesure de son degré d’organisation, l’entropie d’un système est la mesure de son degré de désorganisation ; l’un est simplement le négatif de l’autre. (Wiener, 2014 [1948], p. 69)

Pour corriger cette entropie et organiser un système, le **feedback** (ou parfois "rétroaction") cher à la cybernétique consiste en une réponse du récepteur à son émetteur afin de corriger l'écart entre une état actuel et un état attendu. Cette mécanique favorise l'homéostasie d'un système.
...
Aussi, le designer doit s'intéresser aux isomorphismes et transferts possibles entre différents domaines. Le design raisonnant essentiellement par manipulation de schèmes, le fait de les identifier, de les prélever et de les rémployer est un exercice cognitif essentiel de la profession. D'un projet à un autre, le contexte change systématiquement, et ce qui reste au designer entre ces projets est sa capacité à reconnaître des structures similaires et transférer des motifs de situations passées à la situation présente – ce que Schön appellerait la construction de répertoire :

> Voici ce que je propose : le praticien a constitué un répertoire d'exemples, d'images, de connaissances, et d'actions (Schön, 1983, p. 138).
...
Précisons la dualité du réseau. Il caractérise à la fois des objets bien concrets, dans leur structure réticulaire, mais il peut également servir de représentation et d'outil d'analyse. Le professeur Pierre Musso distingue ce qu'il appelle le **réseau technique** du **réseau technologique**.

Historiquement, le réseau a servi en médecine à décrire les systèmes sanguins et nerveux du corps humain, avant de tomber dans les mains des ingénieurs au 18^e^ siècle. Ces derniers avaient besoin d'un paradigme adéquat pour planifier des réseaux de canaux en génie hydraulique ou encore des flux de circulation au sein d'une ville. 

> Le réseau a l'immense avantage de permettre une mise en forme explicative du multiple et du complexe, il offre une "raison graphique". (Musso, 2003, p. 19).
...
Il est possible dans reconstruire la génétique depuis deux ouvrages de Michel Foucault : *Histoire de la Folie à l'Âge Classique* (1972) et *Surveiller et Punir* (1975). 

Dans son *Histoire de la Folie*, Foucault débute son analyse en se focalisant sur la maladie de la lèpre qui a ponctué le Moyen-Âge occidental. Il dépeint le système médiéval de gestion de la lèpre qui articule un discours religieux, une panoplie assignée aux lépreux ou encore les murs épais des léproseries. Le postulat de Foucault est que ce mode de prise en charge ne trouvera d'équivalent que dans la gestion de la folie humaine. Il observe alors la lente évolution du rapport de la société à ses fous, d'abord en agissant sur les corps, puis sur les esprits, et enfin par un conditionnement des corps pour qu'ils se dressent et se surveillent d'eux-mêmes. Au cours de cette chronologie, ce n'est pas seulement le fou qui est pris en charge, c'est aussi le délinquant ou encore le mendiant, tout individu susceptible d'entraver l'ordre publique. Précisons que si le fondement théorique du dispositif s'esquisse dans cette *Histoire de la Folie*, le mot dispositif n'apparaît pas une seule fois.

Son exposition en tant que concept n'advient qu'ensuite dans *Surveiller et Punir* qui ajoute de nouveaux éléments au corpus : la quarantaine en temps de peste, le camp militaire, la prison, etc. C'est d'ailleurs depuis un modèle carcéral que Foucault développe comme une théorie du dispositif. Son raisonnement prend appui sur la mythique figure panoptique de Bentham, qui incarne l'idéal d'une société disciplinaire.

![](https://i.imgur.com/PJ6xBHE.jpg "Le Panoptique de Bentham, issu de The works of Jeremy Bentham vol. IV, 172-3 (domaine public)")

En effet, l'architecture panoptique permet de surveiller nombre de cellule depuis un seul point sans être vu. Plus que cela, le détenu ne sait pas s'il est surveillé ou non, ce qui l'incite à se discipliner lui-même pour éviter une hypothétique sanction. Ce principe d'auto-contrôle est ce que Foucault (ou Bentham avant lui) repère de transposable à de nombreuses situations en quête d'ordre social. Foucault distingue alors le **dispositif** et son **diagramme** : son abstraction fonctionnelle. Il y a donc d'une part ce qu'on peut qualifier d'**agencement matériel** et d'autre part un **principe de fonctionnement**. 

Gilles Deleuze relisant Foucault emploie le terme d'**exposition des rapports de force** pour expliquer le diagramme (Deleuze, 1986, p. 44). En effet, le diagramme permet de sonder les relations de **savoir** et de **pouvoir** instaurées au sein d'un dispositif. En termes de design, cela pose la question des conditions de production et de diffusion d'information ainsi que de mise en capacités des sujets au sein d'un dispositif.

Si le corpus de Foucault compte uniquement des dispositifs disciplinaires, il est possible de s'affranchir de ce sombre héritage pour qualifier des dispositifs contemporains utilisés par des millions d'utilisateurs quotidiennement : le métro parisien, la gamme des services de Google, un système de surveillance, etc. de nombreux objets complexes peuvent être caractérisés de dispositif ou, tout du moins, être analysés en tant que dispositif. Valérie Larroche parle d'**approche dispositive** pour caractériser "la construction d’un objet de recherche intégrant le concept de dispositif dans le questionnement" (Larroche, 2018, p. 162). Elle écrit également :
...
D'après le CNRTL, la biologie décrit l'écologie comme une science qui étudie les relations entre les êtres vivants et le **milieu organique ou inorganique** dans lequel ils vivent. En sociologie, l'écologie est l'étude des **relations réciproques** entre l’homme et son environnement moral, social, économique.

Cela permet d'imaginer quelques étapes d'un travail de méthodologie "écologique" pour appréhender un objet de recherche ou de design – méthodologie potentiellement soutenue par les concepts de système, réseau, dispositif.

* Une indentification puis définition des acteurs dans leur milieu (structure) : humains, non-humains, infrastructures, etc.
* Une description d'un fonctionnement global (fonctions) : objectif du système, paradigmes principaux, etc.
...
> “Do you want it to look good or to work?" Barricades are erected between what are really just two of the many aspects of function. A simple diagram shows the dynamic actions and relationships that make up the function complex (Papanek, 1984, p.7).

Il liste ainsi les réflexions insécables d'un projet de design : 

* **La méthode.** Soit l’interaction entre les outils, les procédés et les matériaux. Cela touche aussi à une utilisation "honnête" des matériaux et un emploi optimal des procédés.
* **L'utilisation.** Derrière ce terme, Papanel regroupe les questions d'utilisabilité et d'externalités sociales.
* **Le besoin.** Est-ce que le produit conçu remplit un besoin physiologique ou comble un désir narcissique ? Pananek parle de "role-playing devices".
* **La télésis.** « The telesic content of a design must reflect the times and conditions that have given rise to it and must fit in with the general human socioeconomic order in which it is to operate » (Papanek, 1984, p. 17).
* **L'association.** Soit notre conditionnement psychologique qui nous pousse à accepter ou non un objet.
...
Caractérisable comme raisonnement graphique, elle pose sur le plan les mots clefs d'un projet pour les interrelier et ainsi révéler l'intrication d'acteurs, de concepts, d'enjeux d'acceptabilité, etc. Ce type de représentation est souvent qualifiée d'arborescente mais elle finit souvent par épouser le modèle de réseau.

La carte heuristique est donc un objet qui se thématise, elle éclaire le projet selon un angle donnée.

* Papier et crayon, puis au propre en PAO.
* Xmind :
...
Dans l'idée de Moles, les axes structurel et fonctionnel permettent de dresser une cartographie schématique du monde des objets.

![](https://i.imgur.com/F0FDTl9.png "Carte schématique du monde des objets (issue de la Théorie des Objets de Moles)")

La complexité structurelle vise donc à énumérer les items d'un ensemble.

> « Une machine à écrire, “c'est fait de …”, suit une liste de pièces. » (Moles, 1972, p. 29)

La complexité fonctionnelle vise à éclater les différentes fonctions constituant le fonctionnement global d'un objet.
...
Que l'on se place dans le référentiel de Foucault ou de Moles, le schéma structurel et le diagramme fonctionnel constituent deux outils graphiques pour explorer un dispositif existant ou en concevoir un nouveau.

# Références

(Von) Bertalanffy Ludwig, *Théorie Générale des Systèmes*, Dunod, 2012 (1968)

Deleuze Gilles, *Foucault*, Collection Critique, Les éditions de minuit, Paris, 1986

Foucault Michel, *Surveiller et Punir*, Gallimard, 1993 (1975)

Foucault Michel, *Histoire de la Folie à l'Âge Classique*, Gallimard 1977 (1972)

Hodge Gail, *Systems  of  Knowledge  Organization  for  Digital  Libraries:  Beyond  Traditional Authority  Files*,  The  Digital  Library  Federation  Council  on  Library  and  Information  Resources, 2000 http://www.clir.org/pubs/abstract/pub91abst.html

Larroche Valérie, *Le dispositif*, ISTE, 2018

Moles Abraham, *Théorie des objets*, éditions Universitaires, 1972

Papanek Victor, *Design for the Real World*, Thames & Hudson, 1984

Wiener Norbert, *La cybernétique*, Seuil, 2014 (1948)
